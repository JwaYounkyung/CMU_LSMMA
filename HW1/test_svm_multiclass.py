...
parser.add_argument("--model_file", default="weights/mfcc-50.svm.model")
parser.add_argument("--feat_dir", default="bof/")
parser.add_argument("--feat_dim", type=int, default=50)
parser.add_argument("--list_videos", default="labels/test_for_students.csv")
parser.add_argument("--output_file", default="mfcc-50.svm.csv")
