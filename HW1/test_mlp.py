...
def parse_args():
  ...
  parser.add_argument("--model_file", default="weights/snf.mlp.model")
  parser.add_argument("--feat_dir", default="snf/")
  parser.add_argument("--feat_dim", type=int, default=50)
  parser.add_argument("--list_videos", default="labels/test_for_students.csv")
  parser.add_argument("--output_file", default="snf.mlp.csv")
